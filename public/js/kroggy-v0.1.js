$(function(){
	...
	function judgeSkills(score) {
		var imageSrc;
		if (score==100) imageSrc = "Albus, is that you?"

			else if (score>90) imageSrc = "Outstanding, noble sir!"

				else if (score>70) imageSrc = "Exceeds expectations!"

					else if (score>50) imageSrc = "Acceptable. For a muggle."
						
						else if (score>35) imageSrc = "Well, that was poor."

							else if (score>20) imageSrc = "olodo!"
								
								else imageSrc = "For shame, troll!"
